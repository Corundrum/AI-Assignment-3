...
public:
	...
	void playAnimation(const std::string& sprite_sheet_name, Animation& animation, int x, int y, float speed_factor, double angle, int alpha, GameObject* object, bool centered = false, SDL_RendererFlip flip = SDL_FLIP_NONE);
